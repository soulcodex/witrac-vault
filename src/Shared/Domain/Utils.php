...
namespace Witrac\Shared\Domain;
...
final class Utils
{
    ...
    public static function fromDateToString(DateTimeInterface $date): string
    {
    ...
    public static function fromStringToDate(string $date): DateTimeInterface
    {
